...
Added a near-wall bonus (|CTE| > 2.0) rewarding low lateral velocity regardless of lane error.
...
| Version | What changed | Crashes | Right err (med) | Left err (mean) | Max |CTE| |
|---------|-------------|---------|-----------------|-----------------|---------|
| v1 | baseline | 30 | — | — | >3.2 |
